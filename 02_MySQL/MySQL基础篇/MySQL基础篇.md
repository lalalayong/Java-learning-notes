...
| CHAR(size)    | 定长字符数据，默认为1个字符，最大长度255                     |
...
ALTER TABLE dept80
ADD job_id varchar(15) AFTER job_name;
```
...
### 7) 删除外键约束(drop foreign key  +  drop index)
...
## 4. 游标(declare...cursor for... open... fetch...into... close...)
